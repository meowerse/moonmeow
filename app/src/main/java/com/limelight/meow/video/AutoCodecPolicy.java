 ...
 * AV1 whitelist, and has a <b>low-latency</b> path: {@code FEATURE_LowLatency}, or a
 * dedicated low-latency codec (MediaTek names them {@code *.lowlatency}). Without all three,
 * automatic keeps choosing HEVC or H.264 exactly as before.
 */
public final class AutoCodecPolicy {
    ...
    public static boolean offerAv1(boolean automatic, boolean hardware, boolean whitelisted,
        ...
        if (!automatic || !hardware || !whitelisted) {
            return false;
        }
