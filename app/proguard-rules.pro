...
# NOTE: this keeps the MEMBERS, not the class NAME. It is sufficient only because
# -dontobfuscate is set at the top of this file. If that is ever removed, the class is
